...
public class UserInterface {
    ...
    /**
     * Main UI class. Will act initially as the main UI for the main menu. After
     * the player select either a TUI or GUI, then the UI will pass the main UI
     * responsibilities to the respective TUI/GUI method
     * 
     * This method takes up four game states: 1. Select NewGame/LoadGame/Help 2.
     * About page, showing info about how to play the game, as well as a back
     * story if we feel like it. 3. Select a Save file page, if the player
     * chooses to load a save. 4. Page asking the player if they want a TUI or
     * GUI.
     * 
     * After page 4, mainMenu ends by calling either TUI or GUI, which will take
     * over main UI responsibilities.
     */
    ...
    /**
     * Pause menu. Clears UI, and displays a choice for the player. From this
     * point, they can: Save Load Exit Print about page The player's selection
     * will take them to the according to their selection.
     */
    ...
    /**
     * Method handling debug mode. Prints the map for the player in a different
     * way, giving full vision to the board.
     */
